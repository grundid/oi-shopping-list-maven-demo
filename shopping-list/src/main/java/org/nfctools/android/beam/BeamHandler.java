...
public abstract class BeamHandler<T extends Activity> extends AbstractActivityHolder<T> {

	protected BeamHandler(T activity) {
		super(activity);
	}

	public abstract List<Record> createNdefMessage();
}
